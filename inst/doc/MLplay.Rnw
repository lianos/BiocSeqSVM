...
orient the decision boundary.

Take note of what happens to the decision boundary and support vectors
when we decrease the value of $C$ to 1. How about when $C = 0.5$. Why
does that happen?
