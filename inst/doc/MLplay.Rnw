...
that was first introduced by Boser, Guyon and Vapnik~\cite{Boser:1992uo}. An
advantageous property of SVMs, as shown in Figure~\ref{fig:svmdecision} is that
they build large margin classifiers. This is important because these types of
classifiers tend to generalized well to unseen data.

types of classifiers tend to generalize well to unseendAs
...
\begin{figure}[htbp]
  ...
  \subfigure{\includegraphics[width=3in]{Rfigs/gen-easyMarginMove.pdf} }}
